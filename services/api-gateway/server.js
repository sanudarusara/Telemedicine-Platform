...
app.listen(PORT, () => {
  ...
  console.log(`    Doctor Service:       ${process.env.DOCTOR_SERVICE_URL || "http://localhost:5006"}`);
  console.log(`    Telemedicine Service: ${process.env.TELEMEDICINE_SERVICE_URL || "http://localhost:5007"}`);
