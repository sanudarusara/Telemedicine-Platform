...
const API_BASE_URL = `${import.meta.env.VITE_API_URL || "http://localhost:5400/api"}/doctors`;
                  ...
                  <CardContent className="p-5 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                      <div className="rounded-lg bg-muted/40 p-3">
                        ...
                        <p className="font-medium break-all">{appointmentNo}</p>
                      </div>
                      ...
                      <div className="rounded-lg bg-muted/40 p-3">
                        ...
                        <p className="font-medium break-all">{centerDisplay}</p>
                      </div>
                    </div>
